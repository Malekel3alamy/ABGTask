...
class UpComingMoviesRemoteMediator(private val moviesRepo : MoviesRepoInrerface, private val moviesDatabase: MoviesDatabase) : RemoteMediator<Int, Movie>() {
    ...
    override suspend fun load(loadType: LoadType, state: PagingState<Int, Movie>): MediatorResult {
        return try {
            ...
            val upcomingMoviesResponse=   moviesRepo.getUpcomingMovies(pageNumber = loadKey).data
            upcomingMoviesResponse?.let {
                val upcomingMovies = upcomingMoviesResponse?.results
